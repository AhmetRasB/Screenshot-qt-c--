    ...
    :  screenshotLabel(new QLabel(this))
{
    ...
    QPushButton *saveScreenshotButton2 = new QPushButton(tr("Save Screenshot Monitor 2"), this);
    connect(saveScreenshotButton2, &QPushButton::clicked, this, &Screenshot::saveScreenshot);
    buttonsLayout->addWidget(saveScreenshotButton2);
